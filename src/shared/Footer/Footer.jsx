...
const Footer = () => {
  return (
    <div className="bg-primary">
      <div className="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4 text--white">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
          <div className="flex flex-col flex-shrink-0">
            <div>
              <h1
                className="md:w-2/12 cursor-pointer text-white dark:text-white font-extrabold font-rajdhani text-4xl"
                aria-label="the Crib."
              >
                LOGO.
              </h1>
            ...
            <div className="gap-x-4 mt-12 space-y-4">
              <h1 className="font-rajdhani font-bold text-2xl text-white">
                Follow Us
              </h1>
              <div className="flex space-x-4">
                <div className=" w-10 h-10 flex-shrink-0 bg-blue-700 cursor-pointer hover:bg-gray-700 rounded-sm flex items-center justify-center">
                  <svg
                    width="18"
                    height="17"
                    viewBox="0 0 18 17"
          ...
          <div className="mt-10 lg:block hidden">
            ...
            <div className="relative cursor-pointer flex items-center justify-between border border-gray-800 mt-4">
              ...
              <div className="absolute right-2 ">
                <button className="bg-secoundary text-white py-2 px-6 font-rajdhani font-bold">
                  Subscribe
                </button>
              </div>
            </div>
